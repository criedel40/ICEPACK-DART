...
ax[1].set_title('Bounded RHF - Control',loc='left',weight='bold',fontsize=12,pad=1.9)
##
for m in range(0,99):
...
ax[2].set_title('Bounded RHF - Constant Err:0.075',loc='left',weight='bold',fontsize=12,pad=1.1)
##
for m in range(0,99):
...
ax[3].set_title('Bounded RHF - Beta Bell Shape',loc='left',weight='bold',fontsize=12,pad=1.4)
####
for m in range(0,99):
...
ax[4].set_title('Bounded RHF - Control Inverse',loc='left',weight='bold',fontsize=12,pad=1.4)
####
...
plt.savefig('idealized_si_gauss_BoundedRHF.jpg',dpi=550,bbox_inches='tight')
os.system('open idealized_si_gauss_BoundedRHF.jpg')
sys.exit()
##########
plt.rc('font', weight='bold')
tim = np.arange(0,dates.shape[0])
