...
data = xr.open_mfdataset('CHECK_INFLATION/INTIAL_TEST/EaKF/assim_output_EaKF_noinf.nc')
aice_eakf_noinf = data.output_aice.values[ind,:]
data.close()
##
data = xr.open_mfdataset('CHECK_INFLATION/INTIAL_TEST/EaKF/assim_output_EaKF_inf.nc')
aice_eakf_inf = data.output_aice.values[ind,:]
data.close()
##
data = xr.open_mfdataset('CHECK_INFLATION/INTIAL_TEST/BOUNDED_RHF_THERSHOLD/assim_output_BoundedRHF_noinf.nc')
aice_bdrhf_noinf = data.output_aice.values[ind,:]
data.close()
##
data = xr.open_mfdataset('CHECK_INFLATION/INTIAL_TEST/BOUNDED_RHF_THERSHOLD/assim_output_BoundedRHF_inf.nc')
...
plt.savefig('idealized_si_varyinflation_test.jpg',dpi=550,bbox_inches='tight')
os.system('open idealized_si_varyinflation_test.jpg')
############################
