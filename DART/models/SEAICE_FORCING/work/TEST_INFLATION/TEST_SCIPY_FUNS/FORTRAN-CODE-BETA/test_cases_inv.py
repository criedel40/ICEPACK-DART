...
x = data.x.values
minef_results = data.inv_cdfs.values
data.close()
...
ax[0].set_title('Beta Inverse CDFs - Solid Line: Scipy - Dashed line:My Fortran Coded Funcs. Funcs.',weight='bold',fontsize=8)
ax[1].set_title('Inverse CDF differences between Scipy and My Fortran Functions',weight='bold',fontsize=8)
