...
ax[0].set_title('Beta CDFs - Solid Line: Scipy - Dashed line:My Coded Funcs.',weight='bold',fontsize=8)
ax[1].set_title('CDF differences between Scipy and My Functions',weight='bold',fontsize=8)
