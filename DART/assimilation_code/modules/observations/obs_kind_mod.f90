...
integer, parameter, public ::        QTY_SEAICE_AGREG_CONCENTR =     1
integer, parameter, public ::       QTY_SEAICE_AGREG_FREEBOARD =     2
integer, parameter, public ::          QTY_SEAICE_AGREG_VOLUME =     3
integer, parameter, public ::      QTY_SEAICE_AGREG_SNOWVOLUME =     4
integer, parameter, public ::       QTY_SEAICE_AGREG_THICKNESS =     5
integer, parameter, public ::       QTY_SEAICE_AGREG_SNOWDEPTH =     6
integer, parameter, public ::           QTY_U_SEAICE_COMPONENT =     7
integer, parameter, public ::           QTY_V_SEAICE_COMPONENT =     8
integer, parameter, public ::          QTY_SEAICE_ALBEDODIRVIZ =     9
integer, parameter, public ::          QTY_SEAICE_ALBEDODIRNIR =    10
integer, parameter, public ::          QTY_SEAICE_ALBEDOINDVIZ =    11
integer, parameter, public ::          QTY_SEAICE_ALBEDOINDNIR =    12
integer, parameter, public ::              QTY_SEAICE_CATEGORY =    13
integer, parameter, public ::              QTY_SEAICE_CONCENTR =    14
integer, parameter, public ::                QTY_SEAICE_VOLUME =    15
integer, parameter, public ::            QTY_SEAICE_SNOWVOLUME =    16
integer, parameter, public ::           QTY_SEAICE_SURFACETEMP =    17
integer, parameter, public ::         QTY_SEAICE_FIRSTYEARAREA =    18
integer, parameter, public ::                QTY_SEAICE_ICEAGE =    19
integer, parameter, public ::             QTY_SEAICE_LEVELAREA =    20
integer, parameter, public ::           QTY_SEAICE_LEVELVOLUME =    21
integer, parameter, public ::          QTY_SEAICE_MELTPONDAREA =    22
integer, parameter, public ::         QTY_SEAICE_MELTPONDDEPTH =    23
integer, parameter, public ::           QTY_SEAICE_MELTPONDLID =    24
integer, parameter, public ::          QTY_SEAICE_MELTPONDSNOW =    25
integer, parameter, public ::           QTY_SEAICE_SALINITY001 =    26
integer, parameter, public ::           QTY_SEAICE_SALINITY002 =    27
integer, parameter, public ::           QTY_SEAICE_SALINITY003 =    28
integer, parameter, public ::           QTY_SEAICE_SALINITY004 =    29
integer, parameter, public ::           QTY_SEAICE_SALINITY005 =    30
integer, parameter, public ::           QTY_SEAICE_SALINITY006 =    31
integer, parameter, public ::           QTY_SEAICE_SALINITY007 =    32
integer, parameter, public ::           QTY_SEAICE_SALINITY008 =    33
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY001 =    34
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY002 =    35
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY003 =    36
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY004 =    37
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY005 =    38
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY006 =    39
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY007 =    40
integer, parameter, public ::        QTY_SEAICE_ICEENTHALPY008 =    41
integer, parameter, public ::       QTY_SEAICE_SNOWENTHALPY001 =    42
integer, parameter, public ::       QTY_SEAICE_SNOWENTHALPY002 =    43
integer, parameter, public ::       QTY_SEAICE_SNOWENTHALPY003 =    44
integer, parameter, public ::              QTY_SOM_TEMPERATURE =    45
integer, parameter, public ::                    QTY_SEAICE_FY =    46
integer, parameter, public ::              QTY_SEAICE_AGREG_FY =    47
integer, parameter, public ::     QTY_SEAICE_AGREG_SURFACETEMP =    48
integer, parameter, public ::                     QTY_SALINITY =    49
integer, parameter, public ::                  QTY_TEMPERATURE =    50
integer, parameter, public ::        QTY_POTENTIAL_TEMPERATURE =    51
integer, parameter, public ::                     QTY_PRESSURE =    52
integer, parameter, public ::                     QTY_VELOCITY =    53
integer, parameter, public ::          QTY_U_CURRENT_COMPONENT =    54
integer, parameter, public ::          QTY_V_CURRENT_COMPONENT =    55
integer, parameter, public ::          QTY_W_CURRENT_COMPONENT =    56
integer, parameter, public ::                     QTY_DRY_LAND =    57
integer, parameter, public ::         QTY_SEA_SURFACE_PRESSURE =    58
integer, parameter, public ::           QTY_SEA_SURFACE_HEIGHT =    59
integer, parameter, public ::          QTY_SEA_SURFACE_ANOMALY =    60
integer, parameter, public ::             QTY_U_WIND_COMPONENT =    61
integer, parameter, public ::             QTY_V_WIND_COMPONENT =    62
                                                                              
                                                                              
integer, parameter, public :: MAX_DEFINED_QUANTITIES =    62
...
integer, parameter, public ::              SYN_SEAICE_CONCENTR =     1
integer, parameter, public ::           SAT_U_SEAICE_COMPONENT =     2
integer, parameter, public ::           SAT_V_SEAICE_COMPONENT =     3
integer, parameter, public ::              SAT_SEAICE_CONCENTR =     4
integer, parameter, public ::                SAT_SEAICE_VOLUME =     5
integer, parameter, public ::            SAT_SEAICE_SNOWVOLUME =     6
integer, parameter, public ::           SAT_SEAICE_SURFACETEMP =     7
integer, parameter, public ::                    SAT_SEAICE_FY =     8
integer, parameter, public ::              SAT_SEAICE_AGREG_FY =     9
integer, parameter, public ::     SAT_SEAICE_AGREG_SURFACETEMP =    10
integer, parameter, public ::       SAT_SEAICE_AGREG_FREEBOARD =    11
integer, parameter, public ::        SAT_SEAICE_AGREG_CONCENTR =    12
integer, parameter, public ::          SAT_SEAICE_AGREG_VOLUME =    13
integer, parameter, public ::      SAT_SEAICE_AGREG_SNOWVOLUME =    14
integer, parameter, public ::       SAT_SEAICE_AGREG_THICKNESS =    15
integer, parameter, public ::       SAT_SEAICE_AGREG_SNOWDEPTH =    16
                                                                              
                                                                              
integer, parameter, public :: MAX_DEFINED_TYPES_OF_OBS =    16
...
! Also associate types of obs with the quantity.
 ...
 obs_qty_info(           1 )%name = "QTY_SEAICE_AGREG_CONCENTR"
 obs_qty_info(           1 )%nitems =            0
                                                                              
 obs_qty_info(           2 )%index =            2
 obs_qty_info(           2 )%name = "QTY_SEAICE_AGREG_FREEBOARD"
 obs_qty_info(           2 )%nitems =            0
                                                                              
 obs_qty_info(           3 )%index =            3
 obs_qty_info(           3 )%name = "QTY_SEAICE_AGREG_VOLUME"
 obs_qty_info(           3 )%nitems =            0
                                                                              
 obs_qty_info(           4 )%index =            4
 obs_qty_info(           4 )%name = "QTY_SEAICE_AGREG_SNOWVOLUME"
 obs_qty_info(           4 )%nitems =            0
                                                                              
 obs_qty_info(           5 )%index =            5
 obs_qty_info(           5 )%name = "QTY_SEAICE_AGREG_THICKNESS"
 obs_qty_info(           5 )%nitems =            0
                                                                              
 obs_qty_info(           6 )%index =            6
 obs_qty_info(           6 )%name = "QTY_SEAICE_AGREG_SNOWDEPTH"
 obs_qty_info(           6 )%nitems =            0
                                                                              
 obs_qty_info(           7 )%index =            7
 obs_qty_info(           7 )%name = "QTY_U_SEAICE_COMPONENT"
 obs_qty_info(           7 )%nitems =            0
                                                                              
 obs_qty_info(           8 )%index =            8
 obs_qty_info(           8 )%name = "QTY_V_SEAICE_COMPONENT"
 obs_qty_info(           8 )%nitems =            0
                                                                              
 obs_qty_info(           9 )%index =            9
 obs_qty_info(           9 )%name = "QTY_SEAICE_ALBEDODIRVIZ"
 obs_qty_info(           9 )%nitems =            0
                                                                              
 obs_qty_info(          10 )%index =           10
 obs_qty_info(          10 )%name = "QTY_SEAICE_ALBEDODIRNIR"
 obs_qty_info(          10 )%nitems =            0
                                                                              
 obs_qty_info(          11 )%index =           11
 obs_qty_info(          11 )%name = "QTY_SEAICE_ALBEDOINDVIZ"
 obs_qty_info(          11 )%nitems =            0
                                                                              
 obs_qty_info(          12 )%index =           12
 obs_qty_info(          12 )%name = "QTY_SEAICE_ALBEDOINDNIR"
 obs_qty_info(          12 )%nitems =            0
                                                                              
 obs_qty_info(          13 )%index =           13
 obs_qty_info(          13 )%name = "QTY_SEAICE_CATEGORY"
 obs_qty_info(          13 )%nitems =            0
                                                                              
 obs_qty_info(          14 )%index =           14
 obs_qty_info(          14 )%name = "QTY_SEAICE_CONCENTR"
 obs_qty_info(          14 )%nitems =            0
                                                                              
 obs_qty_info(          15 )%index =           15
 obs_qty_info(          15 )%name = "QTY_SEAICE_VOLUME"
 obs_qty_info(          15 )%nitems =            0
                                                                              
 obs_qty_info(          16 )%index =           16
 obs_qty_info(          16 )%name = "QTY_SEAICE_SNOWVOLUME"
 obs_qty_info(          16 )%nitems =            0
                                                                              
 obs_qty_info(          17 )%index =           17
 obs_qty_info(          17 )%name = "QTY_SEAICE_SURFACETEMP"
 obs_qty_info(          17 )%nitems =            0
                                                                              
 obs_qty_info(          18 )%index =           18
 obs_qty_info(          18 )%name = "QTY_SEAICE_FIRSTYEARAREA"
 obs_qty_info(          18 )%nitems =            0
                                                                              
 obs_qty_info(          19 )%index =           19
 obs_qty_info(          19 )%name = "QTY_SEAICE_ICEAGE"
 obs_qty_info(          19 )%nitems =            0
                                                                              
 obs_qty_info(          20 )%index =           20
 obs_qty_info(          20 )%name = "QTY_SEAICE_LEVELAREA"
 obs_qty_info(          20 )%nitems =            0
                                                                              
 obs_qty_info(          21 )%index =           21
 obs_qty_info(          21 )%name = "QTY_SEAICE_LEVELVOLUME"
 obs_qty_info(          21 )%nitems =            0
                                                                              
 obs_qty_info(          22 )%index =           22
 obs_qty_info(          22 )%name = "QTY_SEAICE_MELTPONDAREA"
 obs_qty_info(          22 )%nitems =            0
                                                                              
 obs_qty_info(          23 )%index =           23
 obs_qty_info(          23 )%name = "QTY_SEAICE_MELTPONDDEPTH"
 obs_qty_info(          23 )%nitems =            0
                                                                              
 obs_qty_info(          24 )%index =           24
 obs_qty_info(          24 )%name = "QTY_SEAICE_MELTPONDLID"
 obs_qty_info(          24 )%nitems =            0
                                                                              
 obs_qty_info(          25 )%index =           25
 obs_qty_info(          25 )%name = "QTY_SEAICE_MELTPONDSNOW"
 obs_qty_info(          25 )%nitems =            0
                                                                              
 obs_qty_info(          26 )%index =           26
 obs_qty_info(          26 )%name = "QTY_SEAICE_SALINITY001"
 obs_qty_info(          26 )%nitems =            0
                                                                              
 obs_qty_info(          27 )%index =           27
 obs_qty_info(          27 )%name = "QTY_SEAICE_SALINITY002"
 obs_qty_info(          27 )%nitems =            0
                                                                              
 obs_qty_info(          28 )%index =           28
 obs_qty_info(          28 )%name = "QTY_SEAICE_SALINITY003"
 obs_qty_info(          28 )%nitems =            0
                                                                              
 obs_qty_info(          29 )%index =           29
 obs_qty_info(          29 )%name = "QTY_SEAICE_SALINITY004"
 obs_qty_info(          29 )%nitems =            0
                                                                              
 obs_qty_info(          30 )%index =           30
 obs_qty_info(          30 )%name = "QTY_SEAICE_SALINITY005"
 obs_qty_info(          30 )%nitems =            0
                                                                              
 obs_qty_info(          31 )%index =           31
 obs_qty_info(          31 )%name = "QTY_SEAICE_SALINITY006"
 obs_qty_info(          31 )%nitems =            0
                                                                              
 obs_qty_info(          32 )%index =           32
 obs_qty_info(          32 )%name = "QTY_SEAICE_SALINITY007"
 obs_qty_info(          32 )%nitems =            0
                                                                              
 obs_qty_info(          33 )%index =           33
 obs_qty_info(          33 )%name = "QTY_SEAICE_SALINITY008"
 obs_qty_info(          33 )%nitems =            0
                                                                              
 obs_qty_info(          34 )%index =           34
 obs_qty_info(          34 )%name = "QTY_SEAICE_ICEENTHALPY001"
 obs_qty_info(          34 )%nitems =            0
                                                                              
 obs_qty_info(          35 )%index =           35
 obs_qty_info(          35 )%name = "QTY_SEAICE_ICEENTHALPY002"
 obs_qty_info(          35 )%nitems =            0
                                                                              
 obs_qty_info(          36 )%index =           36
 obs_qty_info(          36 )%name = "QTY_SEAICE_ICEENTHALPY003"
 obs_qty_info(          36 )%nitems =            0
                                                                              
 obs_qty_info(          37 )%index =           37
 obs_qty_info(          37 )%name = "QTY_SEAICE_ICEENTHALPY004"
 obs_qty_info(          37 )%nitems =            0
                                                                              
 obs_qty_info(          38 )%index =           38
 obs_qty_info(          38 )%name = "QTY_SEAICE_ICEENTHALPY005"
 obs_qty_info(          38 )%nitems =            0
                                                                              
 obs_qty_info(          39 )%index =           39
 obs_qty_info(          39 )%name = "QTY_SEAICE_ICEENTHALPY006"
 obs_qty_info(          39 )%nitems =            0
                                                                              
 obs_qty_info(          40 )%index =           40
 obs_qty_info(          40 )%name = "QTY_SEAICE_ICEENTHALPY007"
 obs_qty_info(          40 )%nitems =            0
                                                                              
 obs_qty_info(          41 )%index =           41
 obs_qty_info(          41 )%name = "QTY_SEAICE_ICEENTHALPY008"
 obs_qty_info(          41 )%nitems =            0
                                                                              
 obs_qty_info(          42 )%index =           42
 obs_qty_info(          42 )%name = "QTY_SEAICE_SNOWENTHALPY001"
 obs_qty_info(          42 )%nitems =            0
                                                                              
 obs_qty_info(          43 )%index =           43
 obs_qty_info(          43 )%name = "QTY_SEAICE_SNOWENTHALPY002"
 obs_qty_info(          43 )%nitems =            0
                                                                              
 obs_qty_info(          44 )%index =           44
 obs_qty_info(          44 )%name = "QTY_SEAICE_SNOWENTHALPY003"
 obs_qty_info(          44 )%nitems =            0
                                                                              
 obs_qty_info(          45 )%index =           45
 obs_qty_info(          45 )%name = "QTY_SOM_TEMPERATURE"
 obs_qty_info(          45 )%nitems =            0
                                                                              
 obs_qty_info(          46 )%index =           46
 obs_qty_info(          46 )%name = "QTY_SEAICE_FY"
 obs_qty_info(          46 )%nitems =            0
                                                                              
 obs_qty_info(          47 )%index =           47
 obs_qty_info(          47 )%name = "QTY_SEAICE_AGREG_FY"
 obs_qty_info(          47 )%nitems =            0
                                                                              
 obs_qty_info(          48 )%index =           48
 obs_qty_info(          48 )%name = "QTY_SEAICE_AGREG_SURFACETEMP"
 obs_qty_info(          48 )%nitems =            0
                                                                              
 obs_qty_info(          49 )%index =           49
 obs_qty_info(          49 )%name = "QTY_SALINITY"
 obs_qty_info(          49 )%nitems =            0
                                                                              
 obs_qty_info(          50 )%index =           50
 obs_qty_info(          50 )%name = "QTY_TEMPERATURE"
 obs_qty_info(          50 )%nitems =            0
                                                                              
 obs_qty_info(          51 )%index =           51
 obs_qty_info(          51 )%name = "QTY_POTENTIAL_TEMPERATURE"
 obs_qty_info(          51 )%nitems =            0
                                                                              
 obs_qty_info(          52 )%index =           52
 obs_qty_info(          52 )%name = "QTY_PRESSURE"
 obs_qty_info(          52 )%nitems =            0
                                                                              
 obs_qty_info(          53 )%index =           53
 obs_qty_info(          53 )%name = "QTY_VELOCITY"
 obs_qty_info(          53 )%nitems =            0
                                                                              
 obs_qty_info(          54 )%index =           54
 obs_qty_info(          54 )%name = "QTY_U_CURRENT_COMPONENT"
 obs_qty_info(          54 )%nitems =            0
                                                                              
 obs_qty_info(          55 )%index =           55
 obs_qty_info(          55 )%name = "QTY_V_CURRENT_COMPONENT"
 obs_qty_info(          55 )%nitems =            0
                                                                              
 obs_qty_info(          56 )%index =           56
 obs_qty_info(          56 )%name = "QTY_W_CURRENT_COMPONENT"
 obs_qty_info(          56 )%nitems =            0
                                                                              
 obs_qty_info(          57 )%index =           57
 obs_qty_info(          57 )%name = "QTY_DRY_LAND"
 obs_qty_info(          57 )%nitems =            0
                                                                              
 obs_qty_info(          58 )%index =           58
 obs_qty_info(          58 )%name = "QTY_SEA_SURFACE_PRESSURE"
 obs_qty_info(          58 )%nitems =            0
                                                                              
 obs_qty_info(          59 )%index =           59
 obs_qty_info(          59 )%name = "QTY_SEA_SURFACE_HEIGHT"
 obs_qty_info(          59 )%nitems =            0
                                                                              
 obs_qty_info(          60 )%index =           60
 obs_qty_info(          60 )%name = "QTY_SEA_SURFACE_ANOMALY"
 obs_qty_info(          60 )%nitems =            0
                                                                              
 obs_qty_info(          61 )%index =           61
 obs_qty_info(          61 )%name = "QTY_U_WIND_COMPONENT"
 obs_qty_info(          61 )%nitems =            0
                                                                              
 obs_qty_info(          62 )%index =           62
 obs_qty_info(          62 )%name = "QTY_V_WIND_COMPONENT"
 obs_qty_info(          62 )%nitems =            0
                                                                              
                                                                              
obs_type_info(    1) = obs_type_type(SYN_SEAICE_CONCENTR, &
    'SYN_SEAICE_CONCENTR', QTY_SEAICE_CONCENTR, .false., .false., .false.)
obs_type_info(    2) = obs_type_type(SAT_U_SEAICE_COMPONENT, &
    'SAT_U_SEAICE_COMPONENT', QTY_U_SEAICE_COMPONENT, .false., .false., .false.)
obs_type_info(    3) = obs_type_type(SAT_V_SEAICE_COMPONENT, &
    'SAT_V_SEAICE_COMPONENT', QTY_V_SEAICE_COMPONENT, .false., .false., .false.)
obs_type_info(    4) = obs_type_type(SAT_SEAICE_CONCENTR, &
    'SAT_SEAICE_CONCENTR', QTY_SEAICE_CONCENTR, .false., .false., .false.)
obs_type_info(    5) = obs_type_type(SAT_SEAICE_VOLUME, &
    'SAT_SEAICE_VOLUME', QTY_SEAICE_VOLUME, .false., .false., .false.)
obs_type_info(    6) = obs_type_type(SAT_SEAICE_SNOWVOLUME, &
    'SAT_SEAICE_SNOWVOLUME', QTY_SEAICE_SNOWVOLUME, .false., .false., .false.)
obs_type_info(    7) = obs_type_type(SAT_SEAICE_SURFACETEMP, &
    'SAT_SEAICE_SURFACETEMP', QTY_SEAICE_SURFACETEMP, .false., .false., .false.)
obs_type_info(    8) = obs_type_type(SAT_SEAICE_FY, &
    'SAT_SEAICE_FY', QTY_SEAICE_FY, .false., .false., .false.)
obs_type_info(    9) = obs_type_type(SAT_SEAICE_AGREG_FY, &
    'SAT_SEAICE_AGREG_FY', QTY_SEAICE_AGREG_FY, .false., .false., .false.)
obs_type_info(   10) = obs_type_type(SAT_SEAICE_AGREG_SURFACETEMP, &
    'SAT_SEAICE_AGREG_SURFACETEMP', QTY_SEAICE_AGREG_SURFACETEMP, .false., .false., .false.)
obs_type_info(   11) = obs_type_type(SAT_SEAICE_AGREG_FREEBOARD, &
    'SAT_SEAICE_AGREG_FREEBOARD', QTY_SEAICE_AGREG_FREEBOARD, .false., .false., .false.)
obs_type_info(   12) = obs_type_type(SAT_SEAICE_AGREG_CONCENTR, &
    'SAT_SEAICE_AGREG_CONCENTR', QTY_SEAICE_AGREG_CONCENTR, .false., .false., .false.)
obs_type_info(   13) = obs_type_type(SAT_SEAICE_AGREG_VOLUME, &
    'SAT_SEAICE_AGREG_VOLUME', QTY_SEAICE_AGREG_VOLUME, .false., .false., .false.)
obs_type_info(   14) = obs_type_type(SAT_SEAICE_AGREG_SNOWVOLUME, &
    'SAT_SEAICE_AGREG_SNOWVOLUME', QTY_SEAICE_AGREG_SNOWVOLUME, .false., .false., .false.)
obs_type_info(   15) = obs_type_type(SAT_SEAICE_AGREG_THICKNESS, &
    'SAT_SEAICE_AGREG_THICKNESS', QTY_SEAICE_AGREG_THICKNESS, .false., .false., .false.)
obs_type_info(   16) = obs_type_type(SAT_SEAICE_AGREG_SNOWDEPTH, &
    'SAT_SEAICE_AGREG_SNOWDEPTH', QTY_SEAICE_AGREG_SNOWDEPTH, .false., .false., .false.)
