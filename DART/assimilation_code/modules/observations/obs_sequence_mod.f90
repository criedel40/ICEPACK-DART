...
public :: obs_type, init_obs, destroy_obs, get_obs_def, set_obs_def, &
   ...
   get_obs_key, copy_partial_obs, print_obs,set_obs_variance
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine set_obs_variance(obs, error_var)

type(obs_type),    intent(inout) :: obs
real(r8),          intent(in)    :: error_var

call set_obs_def_error_variance(obs%def,error_var)

end subroutine set_obs_variance
