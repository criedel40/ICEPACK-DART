...
!---------------------------------------------------------------------------  
! Start of code inserted from ../../../observations/forward_operators/obs_def_cice_mod.f90
!---------------------------------------------------------------------------  
...
!---------------------------------------------------------------------------  
! End of code inserted from ../../../observations/forward_operators/obs_def_cice_mod.f90
!---------------------------------------------------------------------------  
...
use obs_kind_mod, only : SAT_U_SEAICE_COMPONENT
use obs_kind_mod, only : SAT_V_SEAICE_COMPONENT
use obs_kind_mod, only : SAT_SEAICE_CONCENTR
use obs_kind_mod, only : SAT_SEAICE_VOLUME
use obs_kind_mod, only : SAT_SEAICE_SNOWVOLUME
use obs_kind_mod, only : SAT_SEAICE_SURFACETEMP
use obs_kind_mod, only : SAT_SEAICE_FY
use obs_kind_mod, only : SAT_SEAICE_AGREG_FY
use obs_kind_mod, only : SAT_SEAICE_AGREG_SURFACETEMP
use obs_kind_mod, only : SAT_SEAICE_AGREG_FREEBOARD
use obs_kind_mod, only : SAT_SEAICE_AGREG_CONCENTR
use obs_kind_mod, only : SAT_SEAICE_AGREG_VOLUME
use obs_kind_mod, only : SAT_SEAICE_AGREG_SNOWVOLUME
use obs_kind_mod, only : SAT_SEAICE_AGREG_THICKNESS
use obs_kind_mod, only : SAT_SEAICE_AGREG_SNOWDEPTH
...
if(assimilate_this_ob .or. evaluate_this_ob) then
   ...
   case(SAT_SEAICE_AGREG_FY)
      ...
      case(SYN_SEAICE_CONCENTR)
         call interpolate(state_handle, ens_size, location, QTY_SEAICE_CONCENTR, expected_obs, istatus)
      case(SAT_U_SEAICE_COMPONENT)
         call interpolate(state_handle, ens_size, location, QTY_U_SEAICE_COMPONENT, expected_obs, istatus)
      case(SAT_V_SEAICE_COMPONENT)
         call interpolate(state_handle, ens_size, location, QTY_V_SEAICE_COMPONENT, expected_obs, istatus)
      case(SAT_SEAICE_CONCENTR)
         call interpolate(state_handle, ens_size, location, QTY_SEAICE_CONCENTR, expected_obs, istatus)
      case(SAT_SEAICE_VOLUME)
         call interpolate(state_handle, ens_size, location, QTY_SEAICE_VOLUME, expected_obs, istatus)
      case(SAT_SEAICE_SNOWVOLUME)
         call interpolate(state_handle, ens_size, location, QTY_SEAICE_SNOWVOLUME, expected_obs, istatus)
      case(SAT_SEAICE_SURFACETEMP)
         call interpolate(state_handle, ens_size, location, QTY_SEAICE_SURFACETEMP, expected_obs, istatus)
      case(SAT_SEAICE_FY)
         call interpolate(state_handle, ens_size, location, QTY_SEAICE_FY, expected_obs, istatus)
